...
namespace FIAPOficina.Domain.Tests.ServiceOrders
{
    public class ServiceOrderServiceTests
    {
        ...
        public void Should_Create_Valid_ServiceOrderService()
        {
            ...
            ServiceOrderService serviceOrderService = new ServiceOrderService(serviceId, serviceOrderID, 4, 27.00m, Guid.NewGuid());
        ...
        public void Should_Create_invalid_ServiceOrderService_Throw_ArgumentException_Quantity()
        {
            Guid serviceId = Guid.NewGuid();
            Guid serviceOrderID = Guid.NewGuid();
            Assert.Throws<ArgumentOutOfRangeException>(() => new ServiceOrderService(serviceId, serviceOrderID, -1, 36.00m, Guid.NewGuid()));
        }
        [Fact]
        public void Should_Create_Valid_ServiceOrderService_Throw_ArgumentException_UnitValue()
        {
            ...
            Guid serviceOrderID = Guid.NewGuid();
            Assert.Throws<ArgumentOutOfRangeException>(() => new ServiceOrderService(materialId, serviceOrderID, 4, -36.00m, Guid.NewGuid()));
        }
        [Fact]
        public void Should_Create_Valid_ServiceOrderService_From_Other_ServiceOrderService()
        {
            ...
            ServiceOrderService serviceOrderServiceOriginal = new ServiceOrderService(serviceIdOriginal, serviceOrderIdOriginal, 4, 36.00m, Guid.NewGuid());
